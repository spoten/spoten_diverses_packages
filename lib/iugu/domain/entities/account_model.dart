...
class AccountModel {
  ...
  bool operator ==(Object other) {
    ...
    return other is AccountModel &&
        ...
        other._fullAddress == _fullAddress &&
        other.priceRange == priceRange &&
        other.physicalProducts == physicalProducts &&
        other.businessDescription == businessDescription &&
        other.personType == personType &&
        other.acceptAutomaticTransfer == acceptAutomaticTransfer &&
        other.cnpj == cnpj &&
        other.companyName == companyName &&
        other.cpf == cpf &&
        other.name == name &&
        other.phone == phone &&
        other.respName == respName &&
        other.respCPF == respCPF &&
        other.bank == bank &&
