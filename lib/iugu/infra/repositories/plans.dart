...
import '../../domain/entities/plan_models_list.dart';
...
class Plans extends IDisposable {
  ...
  Future<PlanModel> getByIdentifier(
      {required String planIdentifier, String customApiToken = ''}) async {
    var result = await apiResource.getById(
        partOfUrl: "/identifier/$planIdentifier", apiUserToken: customApiToken);
    return PlanModel.fromMap(result);
  }
  ...
  Future<PlanModel> create(
      {required PlanRequestMessage plan, String customApiToken = ''}) async {
