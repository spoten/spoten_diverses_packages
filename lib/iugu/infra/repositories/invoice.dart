...
import '../../domain/entities/data_entry/custom_variables.dart';
import '../../domain/entities/data_entry/logs.dart';
...
class Invoice extends IDisposable {
  ...
  Future<InvoiceModel> getById(
      {required String id, String apiUserToken = ''}) async {
  ...
  Future<InvoiceModel> put(
      {required String id, required InvoiceModel model}) async {
  ...
  Future<InvoiceModel> cancel(
      {required String id, String customApiToken = ''}) async {
  ...
  Future<InvoiceModel> duplicate(
      {required String id,
      required InvoiceDuplicateRequestMessage data,
