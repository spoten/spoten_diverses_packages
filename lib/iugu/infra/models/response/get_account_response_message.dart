...
class GetAccountResponseMessage {
  ...
  bool operator ==(Object other) {
    ...
    return other is GetAccountResponseMessage &&
        ...
        other.lastAccountVerificationRequestStatus ==
            lastAccountVerificationRequestStatus &&
        other.lastAccountVerificationRequestData ==
            lastAccountVerificationRequestData &&
        other.lastAccountVerificationRequestDataFeedback ==
            lastAccountVerificationRequestDataFeedback &&
        other.changePlanType == changePlanType &&
        other.subscriptionsTrialPeriod == subscriptionsTrialPeriod &&
        other.disableEmails == disableEmails &&
        other.lastWithdraw == lastWithdraw &&
        other.totalSubscriptions == totalSubscriptions &&
        other.replyToEmail == replyToEmail &&
        other.runningInTestMode == runningInTestMode &&
        other.isMarketplace == isMarketplace &&
        other.enableAutoWithdraw == enableAutoWithdraw &&
        other.balance == balance &&
        other.protectedBalance == protectedBalance &&
        other.payableBalance == payableBalance &&
        other.receivableBalance == receivableBalance &&
        other.commissionBalance == commissionBalance &&
        other.lastMonthVolume == lastMonthVolume &&
        other.currentVolume == currentVolume &&
        other.taxesPaidLastMonth == taxesPaidLastMonth &&
        other.taxesPaidMonth == taxesPaidMonth &&
        other.clientLogoUrl == clientLogoUrl &&
        other.clientSmallLogoUrl == clientSmallLogoUrl;
  }
...
class Information {
  ...
  bool operator ==(Object other) {
    ...
    return other is Information && other.key == key && other.value == value;
  }
