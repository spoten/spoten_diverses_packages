...
class InvoiceRequestMessage {
  ...
  bool operator ==(Object other) {
    ...
    return other is InvoiceRequestMessage &&
        other.email == email &&
        ...
        other.enableLateFine == enableLateFine &&
        other.latePaymentFine == latePaymentFine &&
        other.enableProportionalDailyTax == enableProportionalDailyTax &&
        other.discountCents == discountCents &&
        other.customerId == customerId &&
        other.ignoreDueDateMail == ignoreDueDateMail &&
        other.subscriptionId == subscriptionId &&
        other.paymentMethod == paymentMethod &&
        other.credits == credits &&
        other.enableEarlyPaymentDiscount == enableEarlyPaymentDiscount;
  }
